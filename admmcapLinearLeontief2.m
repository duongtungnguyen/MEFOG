function [num_ite,p,u,x,x_vector,gap1_trace,gap2_trace,uti_trace,p_trace] = admmcapLinearLeontief2(budget,basedemand,capa,cap,rho,tol1,tol2)
...
while 1
    ...
    parfor i = 1:N
        [x_update(i,:),uti(i)] = ...
            admmBuyerUpdate2(budget(i),base(i,:),cap(i),x_old(i,:),z_old(i,:),v_old,rho,R);
    end
    uti
    x_new = x_update
    v_old
    ...
    %%%%% Z_UPDATE %%%%%%%%%%%%%%%
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%          
    [z_update,v_update] = admmSellerUpdate2(v_old,x_new,rho);
    z_new = z_update
    v_new = v_update;    
    v_new*rho
